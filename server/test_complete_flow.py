...
def test_complete_flow():
    """Test the complete auto-rejection flow with 2026-02-28"""
    ...
    print("Date: 2026-02-28 (has pending resident booking, no official booking)")
    
    # Test 1: Check existing booking
    print("\n1. CHECKING EXISTING RESIDENT BOOKING...")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Find booking for 2026-02-28, Facility 1
            target_bookings = [
                booking for booking in bookings 
                if booking.get('booking_date') == '2026-02-28' and booking.get('facility_id') == 1
            ]
            
            print(f"Found {len(target_bookings)} bookings for 2026-02-28, Facility 1:")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for i, booking in enumerate(rejected_bookings):
                ...
                # Verify timeslot shows actual resident time
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Final booking status for 2026-02-28, Facility 1:")
