...
def find_dates_with_resident_bookings():
    """Find dates that have resident bookings for Test Facility"""
    
    conn = sqlite3.connect('barangay.db')
    cursor = conn.cursor()
    
    print("=== FINDING DATES WITH RESIDENT BOOKINGS ===")
    ...
    print(f"Found {len(dates)} dates with resident bookings:")
